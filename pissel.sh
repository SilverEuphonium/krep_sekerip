...
git clone https://github.com/SilverEuphonium/android_device_xiaomi_earth.git -b PixelOS-16.0 device/xiaomi/earth
...
git clone https://github.com/SilverEuphonium/android_hardware_xiaomi.git -b lineage-23.0 hardware/xiaomi
